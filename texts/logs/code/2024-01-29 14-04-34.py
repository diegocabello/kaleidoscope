        ...
        for section in chapter: 
            ...
            for counter, sentence in enumerate(sentence_list):
                if not sentence or not sentence.isspace():
                    ...
                    for counterr, cell in enumerate(sheet[counterr + 3]):
                        print(columns_values[columns[counterr][0]]['color'])
                        cell.fill, cell.border = columns_values[columns[counterr][0]]['color'], border # sorry that is a mess 
