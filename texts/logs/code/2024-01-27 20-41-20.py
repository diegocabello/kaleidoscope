...
def main(book_name=None):
    ...
    for count, chapter in enumerate(chapter_list):
        ...
        sentence_list2 = [sub_sentence + ';' if len(sentence.split(';')) > 1 and sub_sentence != sentence.split(';')[-1] else sub_sentence for sentence in sentence_list for sub_sentence in sentence.split(';') if sub_sentence] 
        if sentence_list != sentence_list2:
