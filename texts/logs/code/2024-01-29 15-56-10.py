        ...
        for section in chapter:                                                                                 #    ====SECTION====
            ...
            if typer == 'quote':
                if prev_type == 'quote':
                    ...
                    speaker = get_speaker(section) if get_speaker(section) else None   # defines it if not there
            ...
            for counter, sentence in enumerate(sentence_list):
                if not sentence or not sentence.isspace():
                    ...
                    columns_values = {
                        ...
                        'speaker': {'value': speaker if speaker else None, 'color': color},
                    ...
                    for counterrr, cell in enumerate(sheet[start_index]):
                        #print(columns_values[columns[counterrr][0]]['color'])
