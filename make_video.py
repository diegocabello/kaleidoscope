...
overlay_image = Image.new('RGBA', (1920, 1080), color = (0, 0, 0, 40))
overlay_image_path = r'c:\users\diego\documents\my stuff\programming stuff\babel\resources\overlay.png'
overlay_image.save(overlay_image_path)
overlay_image_obj = Image.open(overlay_image_path)
c_print(yellow, 'made overlay image')
